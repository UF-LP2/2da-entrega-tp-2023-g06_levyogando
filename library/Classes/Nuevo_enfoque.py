...
class cNuevoEnfoque:
    ...
    def contar_pacientes_gravedad_roja(self):
        count = 0
        for paciente in self.Lista_de_pacientes:
            if paciente.getGravedad() == 0:
                count += 1
        return count

    def contar_pacientes_gravedad_naranja(self):
        count = 0
        for paciente in self.Lista_de_pacientes:
    ...
    def contar_pacientes_gravedad_amarillo(self):
        count = 0
        for paciente in self.Lista_de_pacientes:
    ...
    def contar_pacientes_gravedad_verde(self):
        count = 0
        for paciente in self.Lista_de_pacientes:
    ...
    def contar_pacientes_gravedad_azul(self):
        count = 0
        for paciente in self.Lista_de_pacientes:
            if paciente.getGravedad() == 4:
                count += 1
        return count
