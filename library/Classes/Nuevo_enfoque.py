...
class cNuevoEnfoque:
    ...
    def encontrar_limites_inferior_gravedad(self, cual_es_limite_con_una_gravedad_mayor, lista=None, inicio=0,
                                            fin=None):
        """
        ...
        if lista[mid].getGravedad() == cual_es_limite_con_una_gravedad_mayor:
            ...
            return self.encontrar_limites_inferior_gravedad(cual_es_limite_con_una_gravedad_mayor, lista, inicio,
                                                            mid - 1)

    def encontrar_limites_superior_gravedad(self, cual_es_limite_con_una_gravedad_menor, lista=None, inicio=0,
                                            fin=None):
        ...
        if lista[mid].getGravedad() == cual_es_limite_con_una_gravedad_menor:
            ...
            next_index = mid + 1
            while lista[next_index].getGravedad() <= lista[fin].getGravedad() and lista[
                next_index].getGravedad() == cual_es_limite_con_una_gravedad_menor:
                next_index += 1
            return next_index
            ...
            # El objetivo está a la izquierda del medio
            return self.encontrar_limites_superior_gravedad(cual_es_limite_con_una_gravedad_menor, lista, inicio,
                                                            mid - 1)
